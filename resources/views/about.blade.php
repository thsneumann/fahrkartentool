    ...
    <div id="accordion" role="tablist">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p>Wir danken dem Museum für Naturkunde Berlin für die Unterstützung bei der Digitalisierung der historischen Fahrkarten.</p>
                <p class="mb-3">
        ...
        <div class="card">
            ...
            <div id="collapseSix" class="collapse" role="tabpanel" aria-labelledby="headingSix" data-parent="#accordion">
                <div class="card-body">
                    ...
                    <p>Stiftung Deutsches Technikmuseum Berlin<br>
                        Direktor Prof. Dr. Dirk Böndel<br>
                        Trebbiner Straße 9, 10963 Berlin<br>
                        Tel 030.90 254 0
                    </p>
                    <p>USt-IdNr gemäß § 27a UStG: DE813348933</p>
                    
                    <h5>Redaktion</h5>
                    <p>Historisches Archiv: Marcel Ruhl<br>
                        Digitale Strategie: Bettina Gries 
                    </p>
                    
                    <h5>Gestaltung / Umsetzung</h5>
                    <p>
                        Thomas Neumann (Programmierung)<br>
                        Nastasja Keller und Yvonne Götzl (Animation &amp; Grafik)
                    </p>
                    
                    <h5>Hinweis zu Nutzungsrechten</h5>
                    <p>
                        Das Fahrkartentool wurde in Laravel und VueJS geschrieben, ist auf <a href="https://github.com/thsneumann/fahrkartentool" target="_blank">Github</a> frei verfügbar und unter der <a href="https://www.gnu.org/licenses/gpl-3.0.en.html" target="_blank">GPL3</a> lizensiert.
                    </p>
                    <p>
                        Die Grafiken und die Intro-Animation stehen unter der <a href="https://creativecommons.org/licenses/by-sa/3.0/de/" target="_blank">CC-BY-SA3.0 DE Lizenz</a> zur Verfügung.
                    </p>
                    <p>
                        Alle historischen Fahrkarten sind unter der Lizenz <a href="https://creativecommons.org/licenses/by-sa/3.0/de/" target="_blank">CC-BY-SA4.0 DE Lizenz</a> verfügbar.
                    </p>
                    <p>
                        Alle Metadaten zu den Fahrkarten stehen unter der Lizenz CC0. 
                    </p>

                    <h5>Datenschutzerklärung / Disclaimer</h5>
                    <ol>
                        <li>
                            <h6>Inhalt des Onlineangebots der Stiftung Deutsches Technikmuseum Berlin</h6>
                            <p>
                                Die Autoren (siehe Impressum) übernehmen keinerlei Gewähr für die Aktualität, Korrektheit, Vollständigkeit oder Qualität der bereitgestellten Informationen. Haftungsansprüche gegen die Autoren, welche sich auf Schäden materieller oder ideeller Art beziehen, die durch die Nutzung oder Nichtnutzung der dargebotenen Informationen bzw. durch die Nutzung fehlerhafter und unvollständiger Informationen verursacht wurden, sind grundsätzlich ausgeschlossen, sofern seitens der Autoren kein nachweislich vorsätzliches oder grob fahrlässiges Verschulden vorliegt.<br>
                        ...
                        <li>
                            <h6>Datenschutz</h6>
                            <p>
                                Die Stiftung DTMB verpflichtet sich, keine personenbezogenen Daten zu sammeln und auszuwerten, es sei denn, dies geschieht mit Zustimmung des/r UserIn.
                                <br>    
                                ...
                                <br>
                                In den folgenden Fällen bitten wir Sie an gesonderter Stelle um Ihre Einwilligung: Registrierung zum Fahrkartentool und zum Sammeln von Erfolgspunkten im Rahmen einer Bestenliste sowie Benachrichtigung per Email bei einem möglichen Gewinn. 
                            </p>
                        </li>
                        <li>
                            <h6>Kommunikation per E-Mail</h6>
                            <p>
