...
@section('content')
  <div class="container-fluid">
    ...
    <div class="row mb-3">
      <div class="col-lg-7">
        <p class="mb-2">Wie schön, dass Sie sich an der Erschließung der historischen Fahrkartensammlung des Deutschen Technikmuseums in
          Berlin beteiligen wollen.</p>
        <p class="mb-2">
          <strong>Und so funktioniert das Ganze:</strong> Sie können auf zwei Arten an den Fahrkarten arbeiten: Im ersten Modus schreiben
        ...
        <p class="mb-2">
          ...
          Berlin freuen!</p>
        <p class="mb-2">
          <strong>Im Menü Erkunden können Sie mitverfolgen, wie die Daten wachsen.</strong> Dort sind die Infos von allen bereits
          bearbeiteten Tickets abrufbar – auf einer Karte oder in verschiedenen Listen.</p>
        <p>
          <strong>Und noch besser:</strong> Alle Einträge, die gesammelt wurden, können per JSON/CSV-Export runterladen werden. Bitte
          nutzen oder teilen Sie die Daten. Es gilt die Creative Commons Lizenz CC0.</p>
      </div>
